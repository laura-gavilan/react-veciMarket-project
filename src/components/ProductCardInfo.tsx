...
export type ProductCardType = {
    ...
    isOwner: boolean;
    commerceId: string;
    navigate: (commerceId: string, productId: string) => void;
    handleDelete: (productId: string) => void;
};

export const ProductCardInfo = memo(({ product, isOwner, commerceId, navigate, handleDelete }: ProductCardType) => {
        ...
        return (
            <div className="flex gap-3 mt-3 justify-center">
                <button
                    ...
                    onClick={() => navigate(commerceId, product._id)}
