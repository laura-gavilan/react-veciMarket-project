export const Contact = () => {
    return (
        <div className="min-h-[calc(100vh-80px)] flex flex-col items-center justify-center px-6 py-16 text-primary-dark">
            ...
            <p className="text-center mb-12 max-w-2xl text-lg md:text-xl text-primary-dark">
                ¿Tienes alguna duda o sugerencia? Escríbenos y nos pondremos en contacto contigo lo antes posible.
            </p>

            <div className="w-full max-w-3xl bg-white rounded-3xl shadow-xl border border-primary-light p-8 transition-all">
                <form className="flex flex-col gap-6">

                    <div className="flex flex-col">
                        <label className="mb-2 font-semibold text-primary" htmlFor="name">
                            Nombre
                        </label>
                        <input
                            type="text"
                            ...
                            className="w-full px-5 py-3 border rounded-3xl border-primary-light focus:outline-none focus:ring-2 focus:ring-accent-primary placeholder:text-primary-light placeholder:italic transition-all"
                        />
                    </div>
                    ...
                    <div className="flex flex-col">
                        <label className="mb-2 font-semibold text-primary" htmlFor="message">
                            Mensaje
                        </label>
                        <textarea
                            id="message"
                ...
                <div className="mt-10 text-center space-y-3 text-primary-dark">
