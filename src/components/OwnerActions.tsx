...
export const OwnerActions = memo(({ commerceId, onDelete }: OwnerActions) => {
    const navigate = useNavigate();

    const onClickEditCommerce = useCallback((id: string) => navigate(`/admin/commerce/${id}/edit`), [navigate, commerceId]);
    const onClickCreateProduct = useCallback((id: string) => navigate(`/admin/commerce/${id}/create`), [navigate, commerceId]);
