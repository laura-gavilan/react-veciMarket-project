...
export type SpinnerColor = "primary" | "secondary" | "danger" | "success";

export type PageSpinnerProps = Partial< {
    message: string;
    size: SpinnerSize;
    color: SpinnerColor;
    className: string;
...
export const PageSpinner = ({ message =  "Cargando...", size = "xl", color = "primary", className = "", fullPage = false, containerClassName = "" }: PageSpinnerProps) => {
