...
export type ErrorItem = { message: string };
...
const CreateProductPage = () => {
    ...
    const handleSubmit = useCallback(async (form: ProductForm) => {
        ...
        try {
            ...
            const e = error as { response?: { data?: { invalidFields?: ErrorItem[] } } };
            console.error("Error creando producto:", error);

            if (e.response?.data?.invalidFields) {
                setErrors(e.response.data.invalidFields);
            } else {
